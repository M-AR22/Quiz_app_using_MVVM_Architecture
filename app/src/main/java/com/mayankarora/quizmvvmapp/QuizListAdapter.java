...
public class QuizListAdapter extends RecyclerView.Adapter<QuizListAdapter.QuizViewHolder> {
    ...
    public OnQuizListListItemClicked onQuizListListItemClicked;

    public QuizListAdapter(OnQuizListListItemClicked onQuizListListItemClicked) {
        this.onQuizListListItemClicked = onQuizListListItemClicked;
    }
        ...
        public QuizViewHolder(@NonNull View itemView) {
            ...
            listBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onQuizListListItemClicked.onItemClicked(getAdapterPosition());
                }
            });
        }
    ...
    public interface OnQuizListListItemClicked{
